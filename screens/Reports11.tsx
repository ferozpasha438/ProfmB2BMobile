...
const Reports11 = () => {
  ...
  return (
    <View style={styles.reports11}>
      ...
      <View style={styles.reports11Child} />
        ...
        <View style={styles.frameParent}>
          <View>
            <View style={styles.projectNameParent}>
              ...
              <Text
                style={[styles.jeddahYachtClub, styles.nameTypo]}
            ...
            <View style={styles.parentSpaceBlock}>
              <Text
                style={[styles.causeOfTransition, styles.theMachineryWasTypo]}
              >
                Cause of transition
              </Text>
              <Text style={[styles.theMachineryWas, styles.theSpaceBlock]}>
                The machinery was inoperable due to a shortage of maintenance
      ...
      <View style={[styles.rectangleContainer, styles.batteryIconPosition]}>
        ...
        <Pressable
          ...
          onPress={() => navigation.navigate("ServicesProvided7")}
        >
          <Image
            style={styles.icon}
            resizeMode="cover"
