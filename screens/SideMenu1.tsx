    ...
    <View style={styles.sideMenu}>
      ...
      <View style={[styles.groupParent, styles.groupParentPosition]}>
        <View style={[styles.rectangleWrapper, styles.groupParentPosition]}>
          <View style={[styles.groupItem, styles.groupParentPosition]} />
        </View>
        <Pressable
          style={styles.menu1}
      ...
      <View style={styles.home1}>
        ...
        />
        <Text style={[styles.recentRequests, styles.servicesLayout]}>
          Recent requests
        </Text>
        ...
        <View style={[styles.frameParent, styles.frameParentPosition]}>
          <Pressable
            ...
            onPress={() => navigation.navigate("SideMenu1")}
          >
            <Image
              style={styles.icon1}
              resizeMode="cover"
        ...
        <Text
          style={[styles.allServicesProvidedContainer, styles.servicesLayout]}
        >
          <Text
        ...
        <View style={[styles.homeItem, styles.iconPosition1]} />
      ...
      <View style={[styles.faceId, styles.childShadowBox]}>
        <View style={styles.attendanceSuccessful}>
          ...
          <View style={styles.areYouSureParent}>
            <Text style={[styles.areYouSure, styles.areYouSureLayout]}>
              Are you sure?
            </Text>
