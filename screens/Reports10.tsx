...
const Reports10 = () => {
  ...
  return (
    <View style={styles.reports10}>
      ...
      <View style={styles.reports10Child} />
        ...
        <View style={styles.frameParent}>
          <View>
            <View style={styles.projectNameParent}>
              ...
              <Text
                style={[styles.jeddahWalkway, styles.nameTypo]}
              >{`Jeddah Walkway `}</Text>
            </View>
            ...
            <View style={[styles.requestNumberParent, styles.parentSpaceBlock]}>
              ...
              <Text style={[styles.omarAlGhamdi, styles.sparePartsLayout]}>
                Omar Al-Ghamdi
              </Text>
            </View>
            <View style={[styles.requestNumberParent, styles.parentSpaceBlock]}>
              ...
              <Text style={[styles.text1, styles.text1Typo]}>20/10/2023</Text>
            </View>
            <View style={[styles.requestNumberParent, styles.parentSpaceBlock]}>
              <Text style={[styles.projectName, styles.nameTypo]}>
                {" "}
