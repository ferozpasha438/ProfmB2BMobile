      ...
      <View style={[styles.rectangleParent, styles.groupChildLayout1]}>
        ...
        <View style={styles.mediumButtonParent}>
          ...
          <View style={[styles.mediumButton1, styles.mediumSpaceBlock]}>
            ...
            <Image
              style={[styles.frameIcon, styles.iconLayout2]}
              resizeMode="cover"
...
`}</Text>
      ...
      <View style={styles.popUpErrolChild} />
      ...
      <View style={[styles.popUpErrolItem, styles.popUpErrolItemPosition]} />
      <View style={[styles.loginWithFaceId, styles.popUpErrolItemPosition]}>
        <View style={[styles.faceId, styles.groupChildShadowBox]}>
          <View
            style={[styles.attendanceSuccessful, styles.popUpErrolItemPosition]}
          >
            <Image
              style={[styles.frameIcon9, styles.iconLayout]}
              resizeMode="cover"
            ...
            <View style={styles.parentSpaceBlock}>
              ...
              <Text style={[styles.text82, styles.textTypo]}>
                شكراً لك على طلبك لقد تم تنفيذه بنجاح يمكنك الآن الاطلاع على
                التفاصيل في سجل الطلبات أو طلب خدمة جديد
              </Text>
            </View>
          </View>
          <Pressable
