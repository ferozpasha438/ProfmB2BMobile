...
const Reports9 = () => {
  ...
  return (
    <View style={styles.reports9}>
      <View style={styles.reports9Child} />
        ...
        <View style={styles.frameParent}>
          <View>
            <View style={styles.projectNameParent}>
              ...
              <Text style={[styles.jeddahWalkway, styles.nameTypo]}>
                Jeddah Walkway
              </Text>
            </View>
            <View style={[styles.requestNumberParent, styles.parentSpaceBlock]}>
              ...
              >{` Request number `}</Text>
              <Text style={[styles.text, styles.textTypo]}>85925</Text>
            </View>
            <View style={[styles.requestNumberParent, styles.parentSpaceBlock]}>
              ...
              <Text style={[styles.omarAlMohammadi, styles.sparePartsLayout]}>
                Omar Al-Mohammadi
              </Text>
            </View>
            <View style={[styles.requestNumberParent, styles.parentSpaceBlock]}>
              ...
              <Text style={[styles.text1, styles.text1Typo]}>30/10/2023</Text>
            </View>
            <View style={[styles.requestNumberParent, styles.parentSpaceBlock]}>
              <Text style={[styles.projectName, styles.nameTypo]}>
                {" "}
