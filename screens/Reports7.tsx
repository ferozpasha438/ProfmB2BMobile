...
const Reports7 = () => {
  ...
  return (
    <View style={styles.reports7}>
      ...
      <View style={styles.reports7Child} />
        ...
        <View style={styles.frameParent}>
          <View>
            <View style={styles.projectNameParent}>
              ...
              <Text style={[styles.jeddahSuperDome, styles.nameTypo]}>
                Jeddah Super Dome
              </Text>
            </View>
            <View style={[styles.requestNumberParent, styles.parentSpaceBlock]}>
              ...
              >{` Request number `}</Text>
              <Text style={[styles.text, styles.textTypo]}>75621</Text>
            </View>
            <View style={[styles.requestNumberParent, styles.parentSpaceBlock]}>
              ...
              <Text style={[styles.ahmedAlAmeri, styles.sparePartsLayout]}>
                Ahmed Al Ameri
              </Text>
            </View>
            <View style={[styles.requestNumberParent, styles.parentSpaceBlock]}>
              ...
              <Text style={[styles.text1, styles.text1Typo]}>24/10/2023</Text>
            </View>
            <View style={[styles.requestNumberParent, styles.parentSpaceBlock]}>
              <Text style={[styles.projectName, styles.nameTypo]}>
                {" "}
