...
const Reports8 = () => {
  ...
  return (
    <View style={styles.reports8}>
      ...
      <View style={styles.reports8Child} />
        ...
        <View style={styles.frameParent}>
          <View>
            <View style={styles.projectNameParent}>
              ...
              <Text style={[styles.redSeaFestival, styles.nameTypo]}>
                Red Sea Festival
              </Text>
            </View>
            ...
            <View style={[styles.requestNumberParent, styles.parentSpaceBlock]}>
              ...
              <Text style={[styles.abdulrahmanAlZahrani, styles.nameTypo]}>
            ...
            <View style={[styles.requestNumberParent, styles.parentSpaceBlock]}>
              ...
              <Text style={[styles.text1, styles.text1Typo]}>29/10/2023</Text>
            </View>
            <View style={[styles.requestNumberParent, styles.parentSpaceBlock]}>
              <Text style={[styles.projectName, styles.nameTypo]}>
                {" "}
            ...
            <View style={[styles.requestNumberParent, styles.parentSpaceBlock]}>
              <Text style={[styles.spareParts, styles.nameTypo]}>
                Spare parts
              </Text>
              <Text
                style={[styles.notAvailable, styles.textLayout]}
              >{`Not available `}</Text>
            </View>
            <View style={[styles.requestNumberParent, styles.parentSpaceBlock]}>
              <Text style={[styles.maintenanceType, styles.nameTypo]}>
