...
const POPUPNEWACCONET = () => {
  const navigation = useNavigation<StackNavigationProp<ParamListBase>>();

  return (
    <View style={styles.popUpNewAcconet}>
...
`}</Text>
      ...
      <View style={styles.popUpNewAcconetChild} />
      ...
      <View
        style={[styles.popUpNewAcconetItem, styles.loginWithFaceIdPosition]}
      />
          ...
          >
            ...
            <View style={styles.parentSpaceBlock}>
              ...
              <Text style={[styles.text82, styles.textTypo]}>
                يمكنك الأن الإطلاع على جميع الإحصائات و الطلبات والتحكم فيها
...
export default POPUPNEWACCONET;
