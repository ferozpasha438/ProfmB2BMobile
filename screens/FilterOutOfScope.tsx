...
const FilterOutOfScope = () => {
  const navigation = useNavigation<StackNavigationProp<ParamListBase>>();

  return (
    <View style={[styles.filterOutOfScope, styles.iconLayout]}>
      ...
      >
        <View style={styles.serviceTypeLayout}>
          <Text style={[styles.projectName, styles.filter4Typo]}>
            Project Name
          </Text>
          <View
        ...
        <View style={styles.statusParent}>
          ...
          <View style={[styles.filter3, styles.filterLayout]}>
      ...
      <View style={styles.groupPosition}>
        ...
        <Text style={[styles.filter4, styles.arrow21Position]}>Filter</Text>
      </View>
    </View>
  );
};
...
export default FilterOutOfScope;
