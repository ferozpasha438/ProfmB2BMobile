    ...
    <View style={[styles.home, styles.homeLayout]}>
      ...
      <View style={styles.iphoneXOrNewer}>
        ...
        <View style={styles.rightSide}>
          ...
          />
          <Image
            style={[styles.recordingIndicatorIcon, styles.iconLayout2]}
            resizeMode="cover"
      ...
      <View style={[styles.rectangleContainer, styles.groupChild1Layout]}>
        ...
        <View style={[styles.polygonParent, styles.polygonParentShadowBox]}>
          <Image
            style={[styles.polygonIcon, styles.iconLayout2]}
            resizeMode="cover"
      ...
      <View style={[styles.loginWithFaceId, styles.homeInnerPosition]}>
        <View style={[styles.faceId, styles.childShadowBox]}>
          <View style={[styles.attendanceSuccessful, styles.homeInnerPosition]}>
            <Image
              style={[styles.frameIcon8, styles.iconLayout1]}
              resizeMode="cover"
              source={require("../assets/frame67.png")}
            />
            <View style={styles.yourRequestHasBeenCompleteParent}>
              <Text style={[styles.yourRequestHas, styles.thankYouForTypo]}>
                Your request has been completed successfully
              </Text>
              <Text style={[styles.thankYouFor, styles.thankYouForTypo]}>
                Thank you for your request. It has been successfully
                implemented. You can now view Click on the details in your order
                history or create a new order
              </Text>
            </View>
          </View>
          <Pressable
...
const styles = StyleSheet.create({
  ...
  yourRequestHasBeenCompleteParent: {
    height: 183,
    marginTop: 16,
    alignItems: "center",
  },
