...
const ListItem = ({ item,surveyPopup,deletePopup,reOpenPopup }) => {
  ...
  const reOpenPopupS=(ticketNumber:any)=>{
    reOpenPopup(ticketNumber);
  };
        ...
        <View style={styles.groupChildLayout1}>
          <View style={[styles.groupView, styles.groupParentLayout]}>
            ...
            <View style={[styles.frameParent5, styles.frameParentPosition3]}>
              ...
              <Pressable style={styles.mediumLayout}  onPress={()=>console.log('Add notes')}>
                  <Text style={[styles.survey, styles.approveTypo]}>Notes </Text>
              </Pressable>

              <Pressable
                style={[styles.mediumButtonNotes, styles.buttonBorderNotes]}
                onPress={()=>reOpenPopupS(item.ticketNumber)}
              >
                <Text style={[styles.notesText, styles.notesTypoText]}>Re-Open</Text>
              </Pressable>
...
const serveyTicketCallback = serveyReponse => {
  ...
  const reOpenPopup = async (ticketNumber:any) =>{
    setDeleteReason("");
    setDeleteTicketNumber(ticketNumber);
    setShowReOpenTicket(true);
  };
  const reOpenTicket = async () => {
    if(deleteTicketNumber!=''){
      var data={
        ticketNumber:deleteTicketNumber,
        reasonCode:deleteReason
      }
      console.log('reOpenTicket : '+JSON.stringify(data));
      WebServer.postDataWithToken('FomMobJobTicketHead/reopenTicket',token,data, reOpenTicketCallback);
    }    
  };
  const reOpenTicketCallback = response => {
    if(response && response.message!=undefined){
      if(response.message==="Successful."){
         ...
         Alert.alert("Successfully re-open the ticket");
  ...
  const renderData = () => {
    return requestList.map((item:any) => (
      <ListItem key={item.id} item={item} surveyPopup={surveyPopup} deletePopup={deletePopup} reOpenPopup={reOpenPopup}  />
...
const getRequestList = async (jwttoken:string) => {
    ...
    WebServer.postDataWithToken('FomMobJobTicketHead/getClosedTicketsListPagination',jwttoken,params, requestListCallback);
  };
    ...
    <>
                              ...
                              >
                                ...
                                <View style={styles.frameParent1}>
                                  <View style={[styles.ellipseParent1, styles.text10Layout]}>
                                    ...
                                    />
                                    <Text style={[styles.completed, styles.textTypo1]}>Completed</Text>
                                  </View>
                                  <Text style={[styles.text5, styles.textSpaceBlock]}>({completedCount})</Text>
                                </View>
                              </Pressable>
                              ...
                              <View style={styles.rectangleLayout}>
                                  ...
                                  <View style={[styles.frameParent, styles.frameParentPosition4]}>
                                    <View style={styles.ellipseParent}>
                                      ...
                                      />
                                      <Text style={[styles.closed, styles.closedLayout]}>
                                         Closed
                                      </Text>
                                      
                                    </View>
                                    <Text style={[styles.text, styles.textSpaceBlock]}>({closedCount})</Text>
                                  </View>
                              </View>
     ...
     <View style={styles.groupParentFrontOffice}>
        ...
        <AfterLoginFooter currentRoute='FrontOffice'/>
          ...
          {showReOpenTicket?<View style={{backgroundColor: Color.colorGray_600,
                        width: "100%",
                        position: "absolute",zIndex:1,
                        height: windowHeight}} />:null}
            {showReOpenTicket?<View style={[styles.rectangleParent1, styles.groupInnerPosition]}>
              <View style={[styles.groupInnerp, styles.groupInnerPosition]} />
              <Text style={[styles.determineClosureReason, styles.closeTypo]}>
                  Re-Open
                </Text>
              ...
              <View style={[styles.reasonForClosure, styles.reasonForClosureStyle]}>
                ...
                <View style={[styles.rectangleParent3, styles.groupChildLayoutp]}>
                  ...
                  <Pressable
                     ...
                     <View style={[styles.buttonChild, styles.buttonPosition]} />
                     <Text style={[styles.close, styles.closeTypo]}>Re-open</Text>
                  </Pressable>
          </View>:null}
