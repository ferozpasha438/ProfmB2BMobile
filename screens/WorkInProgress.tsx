...
const ListItem = ({ item,showJobCompleted,deletePopup,onHoldPopup, foreclosePopup }) => {
  ...
  const showJobCompletedPop=(ticketNumber:any)=>{
    showJobCompleted(ticketNumber);
  };
        ...
        <View style={styles.groupChildLayout1}>
          <View style={[styles.groupView, styles.groupParentLayout]}>
            ...
            <View style={[styles.frameParent5, styles.frameParentPosition3]}>
              ...
              <Pressable style={styles.mediumLayout}  onPress={() =>showJobCompletedPop(item.ticketNumber)}>
                  <Text style={[styles.survey, styles.approveTypo]}>Job Completed</Text>
              </Pressable>
                     ...
                     <Pressable
                          ...
                          onPress={() => navigation.navigate("ViewTicket2",{ticketId:item.id,})}>
                            <Image
                                ...
                                resizeMode="cover"
                                source={require("../assets/alerticon.jpg")}
                              />
                            <Text style={styles.listItemStyle}>Activities</Text>
                        </Pressable>
                        <Pressable
                          style={styles.listItemStyleLink}
...
const WorkInProgress = () => {
 ...
 useEffect(() => {
  ...
  const showJobCompleted = async (ticketNumber:any) =>{
    setDeleteReason("");
    setDeleteTicketNumber(ticketNumber);
    setShowPopup(true);
 };
 const jobCompletedTicket = async () => {
     var requestData={ticketNumber:deleteTicketNumber};
     //console.log(JSON.stringify(requestData))
     WebServer.postDataWithToken('FomMobJobTicketHead/completeJobTicket',token,requestData, jobCompletedTicketCallback); 
 };
const jobCompletedTicketCallback = reponse => {
  ...
  const renderData = () => {
    return requestList.map((item:any) => (
      <ListItem key={item.id} item={item} showJobCompleted={showJobCompleted} deletePopup={deletePopup} onHoldPopup={onHoldPopup} foreclosePopup={foreclosePopup}  />
...
const getRequestList = async (jwttoken:string) => {
    ...
    WebServer.postDataWithToken('FomMobJobTicketHead/getWorkInprogressTicketsListPagination',jwttoken,params, requestListCallback);
  };
    ...
    <>
                      ...
                      <ScrollView  horizontal={true}
                              ...
                              >
                                ...
                                <View style={styles.ellipseContainer}>
                                  ...
                                  />
                                  <Text style={[styles.arrived1, styles.textTypo1]}>
                                  Approved
                                  </Text>
                                </View>
                                <Text style={[styles.text2, styles.textLayout]}>({approvedCount})</Text>
                              </Pressable>
                              <View style={styles.rectangleLayout}>
                                  ...
                                  <View style={[styles.frameParent, styles.frameParentPosition4]}>
                                    <View style={styles.ellipseParent}>
                                      ...
                                      />
                                      <Text style={[styles.workInProgress, styles.textTypo1]}>Work in progress</Text>
                                    </View>
                                    <Text style={[styles.text, styles.textSpaceBlock]}>({workInProgressCount})</Text>
                                  </View>
                              </View>
                              <Pressable
                                style={[styles.rectangleGroup, styles.rectangleLayout]}
     ...
     <View style={styles.groupParentFrontOffice}>
        ...
        <AfterLoginFooter currentRoute='FrontOffice'/>
          ...
          {showPopup?<View style={{backgroundColor: Color.colorGray_600,
                        width: "100%",
                        position: "absolute",zIndex:1,
                        height: windowHeight}} />:null}
            {showPopup?<View style={[styles.rectangleParentS, styles.groupInnerPosition5]}>
              ...
              <View style={[styles.reasonForClosure, styles.reasonForClosureStyle]}>
                ...
                <CheckBox 
                     ...
                     isChecked={isChecked}
                     rightText={"Job Completed"}/>
                </View>
              </View>
              <Pressable
                  style={[styles.button5, styles.buttonPosition]}
                  onPress={jobCompletedTicket}>
