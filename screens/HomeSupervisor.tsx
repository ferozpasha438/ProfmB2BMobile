...
// import AfterLoginFooter from '../components/AfterLoginFooter.js';
...
//    WebServer.postDataWithToken('FomMobJobTicketHead/getProjectOpenTicketsList?siteCode='+projectCode,token,'', getDashBoardDataCallback);
//  };
...
//                   setCompletedPercentage(getDashBoardDataReponse.statusWiseTickets[i].percentage+'%');
//                   setCompletedLeftPercentage((100-getDashBoardDataReponse.statusWiseTickets[i].percentage)+'%');
...
//               setInCompletePercentage(getDashBoardDataReponse.statusWiseTickets[i].percentage+'%');
//               setInCompleteLeftPercentage((100-getDashBoardDataReponse.statusWiseTickets[i].percentage)+'%');
...
//               setOutOfScopePercentage(getDashBoardDataReponse.statusWiseTickets[i].percentage+'%');
//               setOutOfScopeLeftPercentage((100-getDashBoardDataReponse.statusWiseTickets[i].percentage)+'%');
...
//               setInTransitPercentage(getDashBoardDataReponse.statusWiseTickets[i].percentage+'%');
//               setInTransitLeftPercentage((100-getDashBoardDataReponse.statusWiseTickets[i].percentage)+'%');
...
//               setOnHoldPercentage(getDashBoardDataReponse.statusWiseTickets[i].percentage+'%');
//               setOnHoldLeftPercentage((100-getDashBoardDataReponse.statusWiseTickets[i].percentage)+'%');
//             }
...
//     WebServer.getDataWithToken('FomMobJobTicketHead/getAllProjectList',jwttoken,'', projectDataForSupervisorCallback);
//   };
...
//           <Pressable style={[styles.mediumButton1, styles.mediumPosition]}
