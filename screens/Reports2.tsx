...
const Reports2 = () => {
  ...
  return (
    <View style={styles.reports2}>
      <View style={styles.reports2Child} />
      <View style={styles.rectangleParent}>
        ...
        <View style={[styles.frameParent, styles.containerPosition]}>
          <View style={styles.groupFlexBox}>
            ...
            <Text style={[styles.text1, styles.textTypo3]}>85925</Text>
            <Text style={[styles.text2, styles.textTypo3]}>عاصم المحمدي</Text>
