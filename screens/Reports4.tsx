...
const Reports4 = () => {
  ...
  return (
    <View style={styles.reports4}>
      <View style={styles.rectangleParent}>
        ...
        <View style={[styles.frameParent, styles.containerPosition]}>
          <View style={styles.groupFlexBox}>
            <Text style={[styles.text, styles.textLayout]}>جدة سوبر دوم</Text>
            <Text style={[styles.text1, styles.textTypo3]}>75621</Text>
            <Text style={[styles.text2, styles.textTypo3]}>احمد العامري</Text>
      ...
      <View style={styles.reports4Child} />
