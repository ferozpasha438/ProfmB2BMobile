...
const ListItem = ({ item,surveyPopup,deletePopup,backToPreviousPopup, onHoldPopup, inTransitPopup,addNotesPopup,notesListPopup  }) => {
  // State to manage modal visibility
  const [modalVisible, setModalVisible] = useState(false);
  const navigation = useNavigation<StackNavigationProp<ParamListBase>>();
  ...
  const backToPreviousS=(ticketNumber:any)=>{
    backToPreviousPopup(ticketNumber);
  };
  const onHoldPopupS=(ticketNumber:any)=>{
    onHoldPopup(ticketNumber);
  };
  const inTransitPopupS=(ticketNumber:any)=>{
    inTransitPopup(ticketNumber);
  };
        ...
        <View style={styles.groupChildLayout1}>
          <View style={[styles.groupView, styles.groupParentLayout]}>
            ...
            <View style={[styles.frameParent5, styles.frameParentPosition3]}>
              ...
              <Pressable style={styles.mediumLayout}  onPress={() => navigation.navigate("CreateWorkOrder",{ticketNumber:item.ticketNumber,})}>
                  <Text style={[styles.survey, styles.approveTypo]}>{item.isConvertedToWorkOrder?'View Work Order':'Create Work Order'}  </Text>
              </Pressable>
            ...
            {modalVisible&&(<View style={styles.modalContainer}>
                      <Pressable
                          ...
                          onPress={() =>onHoldPopupS(item.ticketNumber)}>
                            <Image
                                style={styles.groupIconPop}
                                resizeMode="cover"
                                source={require("../assets/onholdicon.jpg")}
                              />
                            <Text style={styles.listItemStyle}>On Hold</Text>
                        </Pressable>
                        <Pressable
                          style={styles.listItemStyleLink}
                          onPress={() =>backToPreviousS(item.ticketNumber)}>
                            <Image
                                style={styles.groupIconPop}
                                resizeMode="cover"
                                source={require("../assets/backicon.jpg")}
                              />
                            <Text style={styles.listItemStyle}>Back To Previous </Text>
                        </Pressable>
                        <Pressable
                          style={styles.listItemStyleLink}
                        ...
                        <Pressable
                          style={styles.listItemStyleLink}
                          onPress={() => inTransitPopupS(item.ticketNumber)}>
                            <Image
                                style={styles.groupIconPop}
                                resizeMode="cover"
                                source={require("../assets/intransiticon.jpg")}
                              />
                            <Text style={styles.listItemStyle}>In Transit</Text>
                        </Pressable>
                </View>)}
        </View>
...
const Approved = () => {
  ...
  const [showBacktoPrevious, setShowBacktoPrevious] = useState(false);
  const [showOnHold, setOnHold] = useState(false);
  const [showInTransit, setInTransit] = useState(false);
  const [isInTransitChecked, setIsInTransitChecked] = useState(false);
  ...
  const toggleIsInTransit = () => {
    setIsInTransitChecked(!isInTransitChecked);
  };
...
const serveyTicketCallback = serveyReponse => {
  ...
  const backToPreviousPopup = async (ticketNumber:any) =>{
    setDeleteReason("");
    setDeleteTicketNumber(ticketNumber);
    setShowBacktoPrevious(true);
};
  const backToPrevious = async () => {
    WebServer.postDataWithToken('FomMobJobTicketHead/approveToPrevStateJobTicketHeadByIdQuery?ticketNumber='+deleteTicketNumber,token,'', backToPreviousCallback);
  };
  const backToPreviousCallback = response => {
  ...
  const onHoldPopup = async (ticketNumber:any) =>{
    setDeleteReason("");
    setDeleteTicketNumber(ticketNumber);
    setOnHold(true);
  };
  const onHoldTicket = async () => {
    var data={
      ticketNumber:deleteTicketNumber,
      reasonCode:deleteReason
    }
    console.log('onHoldTicket : '+JSON.stringify(data));
    WebServer.postDataWithToken('FomMobJobTicketHead/holdJobTicket',token,data, onHoldTicketCallback);
  };
  const onHoldTicketCallback = reponse => {
    if(reponse && reponse.message!=undefined){
      if(reponse.message==="Successful."){
       ...
       // setPageHeight(windowHeight);
        ...
        Alert.alert("Successfully on hold the ticket");
  ...
  const inTransitPopup = async (ticketNumber:any) =>{
    setDeleteReason("");
    setDeleteTicketNumber(ticketNumber);
    setInTransit(true);
  };
  const makeIntransit= async () => {
    if(isInTransitChecked){
      var data={
        ticketNumber:deleteTicketNumber,
        reasonCode:''
      }
      WebServer.postDataWithToken('FomMobJobTicketHead/changeTicketStatusToInTransit',token,data, makeIntransitCallback);
    }
  };
  const makeIntransitCallback = reponse => {
    if(reponse && reponse.message!=undefined){
      if(reponse.message==="Successful."){
        setPage(0);
        setDeleteReason("");
       ...
       // setPageHeight(windowHeight);
        ...
        Alert.alert("Successfully In Transit the ticket");
 ...
 const notesListPopupCallback = response => {
  ...
  const renderData = () => {
    return requestList.map((item:any) => (
      <ListItem key={item.id} item={item} surveyPopup={surveyPopup} deletePopup={deletePopup} backToPreviousPopup={backToPreviousPopup} onHoldPopup={onHoldPopup} inTransitPopup={inTransitPopup} addNotesPopup={addNotesPopup}  notesListPopup={notesListPopup} />
...
const getRequestList = async (jwttoken:string) => {
    ...
    WebServer.postDataWithToken('FomMobJobTicketHead/getApprovedTicketsListPagination',jwttoken,params, requestListCallback);
  };
    ...
    <>
                      ...
                      <ScrollView  horizontal={true}
                              ...
                              <View style={styles.rectangleLayout}>
                                  ...
                                  <View style={[styles.frameParent, styles.frameParentPosition4]}>
                                    ...
                                    <Text style={[styles.text, styles.textSpaceBlock]}>({approvedCount})</Text>
                                  </View>
                              </View>
                              <Pressable
                                style={[styles.rectangleGroup, styles.rectangleLayout]}
     ...
     <View style={styles.groupParentFrontOffice}>
        ...
        <AfterLoginFooter currentRoute='FrontOffice'/>
          ...
          {showBacktoPrevious?<View style={{backgroundColor: Color.colorGray_600,
                        width: "100%",
                        position: "absolute",zIndex:1,
                        height: windowHeight}} />:null}
            {showBacktoPrevious?<View style={[styles.rectangleParentS, styles.groupInnerPosition5]}>
              <View style={[styles.groupInnerp, styles.groupInnerPosition5]} />
              <Text style={[styles.determineClosureReason, styles.closeTypo]}>
                    Back To Previous
                </Text>
              ...
              <View style={[styles.reasonForClosure, styles.reasonForClosureStyle]}>
                <View style={[styles.rectangleParent150, styles.groupChildLayoutp]}>
                   <Text style={styles.textBackTo}>Are You Sure You Want To Go Back TO The Previous Step? </Text>
                </View>
              </View>
              <Pressable
                  style={[styles.button5, styles.buttonPosition]}
                  ...
                  <View style={[styles.buttonChildForComplete, styles.buttonPosition]} />
                  <Text style={[styles.close, styles.closeTypo]}>Back To Previous</Text>
                </Pressable>
          ...
          {showOnHold?<View style={{backgroundColor: Color.colorGray_600,
                        width: "100%",
                        position: "absolute",zIndex:1,
                        height: windowHeight}} />:null}
            {showOnHold?<View style={[styles.rectangleParent1, styles.groupInnerPosition]}>
              <View style={[styles.groupInnerp, styles.groupInnerPosition]} />
              <Text style={[styles.determineClosureReason, styles.closeTypo]}>
                  On Hold
                </Text>
              ...
              <View style={[styles.reasonForClosure, styles.reasonForClosureStyle]}>
                ...
                <View style={[styles.rectangleParent3, styles.groupChildLayoutp]}>
                  ...
                  <Pressable
                      style={[styles.button, styles.buttonPosition]}
                      onPress={onHoldTicket}>
                     <View style={[styles.buttonChild, styles.buttonPosition]} />
                     <Text style={[styles.close, styles.closeTypo]}>On Hold</Text>
                  </Pressable>
          </View>:null}
          ...
          {showInTransit?<View style={{backgroundColor: Color.colorGray_600,
                        width: "100%",
                        position: "absolute",zIndex:1,
                        height: windowHeight}} />:null}
          {showInTransit?<View style={[styles.rectangleParentS, styles.groupInnerPosition5]}>
              <View style={[styles.groupInnerp, styles.groupInnerPosition5]} />
              <Text style={[styles.determineClosureReason, styles.closeTypo]}>
                    In Transit
                </Text>
              ...
              <View style={[styles.reasonForClosure, styles.reasonForClosureStyle]}>
                ...
                <CheckBox 
                     style={{flex: 1, padding: 10}}
                     onClick={toggleIsInTransit}
                     isChecked={isInTransitChecked}
                     rightText={"In Transit"}/>
                </View>
              </View>
              <Pressable
                  style={[styles.button5, styles.buttonPosition]}
                  onPress={makeIntransit}>
                  <View style={[styles.buttonChildForComplete, styles.buttonPosition]} />
