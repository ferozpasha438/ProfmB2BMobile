...
import VerificationCode1 from "./VerificationCode1";
import { Color, FontFamily, FontSize, Border, Padding } from "../GlobalStyles";

type VerificationCode2Type = {
  onClose?: () => void;
};

const VerificationCode2 = ({ onClose }: VerificationCode2Type) => {
    ...
    <>
      <View style={[styles.verificationCode, styles.iconLayout]}>
        ...
        <View style={styles.groupParent}>
          <View style={styles.groupViewLayout}>
            ...
            <Text style={[styles.text1, styles.text1Typo]}>23655</Text>
            ...
            <View style={styles.lineParent}>
              ...
              <Text style={[styles.completed1, styles.completed1FlexBox]}>
                Completed
              </Text>
            </View>
          ...
          <View style={[styles.groupView, styles.groupViewLayout]}>
            <View style={styles.groupShadowBox} />
            <Text style={[styles.text1, styles.text1Typo]}>25416</Text>
            <Text style={[styles.orderNumber, styles.orderNumberClr]}>
              Order number :
            </Text>
            <Text style={[styles.maintenanceType, styles.text2Typo]}>
          ...
          <View style={[styles.groupView, styles.groupViewLayout]}>
            <View style={styles.groupShadowBox} />
            <Text style={[styles.text1, styles.text1Typo]}>26890</Text>
            <Text style={[styles.orderNumber, styles.orderNumberClr]}>
              Order number :
            </Text>
            <Text style={[styles.maintenanceType, styles.text2Typo]}>
        ...
        <View style={styles.groupChild18Position}>
          ...
          <Text style={[styles.servicesProvided, styles.areYouSureTypo]}>
            Services provided
          </Text>
        </View>
        <View
          style={[styles.verificationCodeInner, styles.loginWithFaceIdPosition]}
        />
        <View style={[styles.loginWithFaceId, styles.loginWithFaceIdPosition]}>
          <View style={[styles.faceId, styles.faceIdShadowBox]}>
            <View style={styles.areYouSureYouWantToCloseParent}>
              <Text style={[styles.areYouSure, styles.areYouSureTypo]}>
                Are you sure you want to Close the Ticket
              </Text>
              <Text style={[styles.closingTheTicket, styles.completedTypo]}>
      ...
      <Modal animationType="fade" transparent visible={buttonContainer1Visible}>
        <View style={styles.buttonContainer1Overlay}>
          ...
          />
          <VerificationCode1 onClose={closeButtonContainer1} />
        </View>
      </Modal>
    </>
  );
